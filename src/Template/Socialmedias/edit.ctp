...
<div class="socialmedias form">
    
    <fieldset>
        <legend><?= ___('edit socialmedia') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $socialmedia->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($socialmedia, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
