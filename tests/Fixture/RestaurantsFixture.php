...
class RestaurantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'res_lat' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'res_long' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'res_long' => 1,
            'category_id' => 1,
            'created' => '2019-04-16 12:00:33',
            'modified' => '2019-04-16 12:00:33'
        ],
    ];
}
