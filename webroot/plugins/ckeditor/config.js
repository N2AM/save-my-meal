...
CKEDITOR.editorConfig = function( config ) {
   ...
   config.filebrowserBrowseUrl = 'http://newcodesroots.codesroots.com/webroot/ckeditor/kcfinder/browse.php?opener=ckeditor&type=files';
   ...
   config.filebrowserImageUploadUrl = 'http://newcodesroots.codesroots.com/tickets/upload';
